...
public class Main {
    public static void main(String[]args){
                ...
                int qtd;
                String periodo;
                Listaestatica dadosLista = new Listaestatica(10);
		...
		while(op!=9){
			...
			case 3:JOptionPane.showMessageDialog(null,"O elemento removido foi:\n"+dadosLista.RemoveInicio());
				break;
				
                         case 4:JOptionPane.showMessageDialog(null,"O elemento removido foi:\n"+dadosLista.RemoveFinal());
				break;
